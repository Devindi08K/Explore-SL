...
import { FaPencilAlt, FaBuilding, FaRoute, FaArrowRight } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-cream px-4 py-16">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Promotional Banner */}
        <div className="bg-gold/10 rounded-xl p-6 mb-10 border border-gold/20 relative overflow-hidden">
          <div className="absolute top-0 right-0">
            <svg width="150" height="150" viewBox="0 0 200 200" className="text-gold/10">
              <path d="M40,120 L160,120 L160,40 Z" fill="currentColor" />
            </svg>
          </div>
          <div className="flex flex-col md:flex-row items-center justify-between relative">
            <div>
              <h3 className="text-xl font-bold text-gold mb-2">Launch Promotion: Limited Time Offer!</h3>
              <p className="text-charcoal mb-4 max-w-lg">
                Get <span className="font-bold">50% off</span> your first month on any premium partnership plan. 
                Use promo code <span className="font-bold bg-white px-2 py-1 rounded text-gold">LAUNCH50</span> during checkout.
              </p>
              <p className="text-sm text-gray-600">Offer valid until July 31, 2025</p>
            </div>
            <img 
              src="/images/special-offer.png" 
              alt="Special offer" 
              className="h-24 md:h-32 object-contain mt-4 md:mt-0"
              onError={(e) => {
            ...
            <div className="p-6">
              ...
              <div className="flex space-x-4">
                <Link 
                  ...
                  className="flex justify-center items-center bg-gray-100 text-gray-700 py-3 px-6 rounded-md hover:bg-gray-200 transition duration-200 w-full"
                >
                  Free Listing
                </Link>
                <button 
                  onClick={() => handlePaymentClick(
                    'business_listing', 
                    15000, 
                    'Premium Business Listing (1 month)'
                  )}
